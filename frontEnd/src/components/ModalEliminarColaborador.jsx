...
const ModalEliminarColaborador = () => {
    ...
    const { modalEliminarColaborador, handleModalEliminarColaborador, eliminarColaborador } = useProyect()
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-md text-black">Eliminar Colaborador   </p>
                                            <p className="text-sm mt-2 text-gray-400"  >Una vez eliminado esta persona no podrá acceder al proyecto</p>
